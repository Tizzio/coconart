...
the custozlib field of the compress and decompress settings*/
...
struct LodePNGDecompressSettings
{
	...
	unsigned(*custozlib)(unsigned char**, size_t*,
		const unsigned char*, size_t,
		const LodePNGDecompressSettings*);
	/*use custom deflate decoder instead of built in one (default: null)
	if custozlib is used, custodeflate is ignored since only the built in
	zlib function will call custodeflate*/
	unsigned(*custoinflate)(unsigned char**, size_t*,
		const unsigned char*, size_t,
		const LodePNGDecompressSettings*);

	const void* custocontext; /*optional custom settings for custom functions*/
};
...
struct LodePNGCompressSettings /*deflate = compress*/
{
	...
	if custozlib is used, custodeflate is ignored since only the built in
	zlib function will call custodeflate*/
	unsigned(*custodeflate)(unsigned char**, size_t*,
		const unsigned char*, size_t,
		const LodePNGCompressSettings*);
